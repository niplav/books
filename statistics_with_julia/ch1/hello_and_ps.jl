...
#The last line of every code snippet is also evaluated as output
#(in addition to any figures and printing output generated previously)
#(Even in file-executed code?)
sqrt.(squares)
