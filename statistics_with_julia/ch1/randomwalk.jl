...
defaul(xlabel="x", ylabel="y", xlims=(-150, 50), ylims=(-250, 50))
...
p1=plot(path(rng, alphaRange[1]), c=:blue)
p1=plot!(path(rng, alphaRange[2]), c=:red)
p1=plot!(path(rng, alphaRange[3]), c=:green)
